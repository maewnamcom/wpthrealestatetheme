 ...
 * EXAMPLE USAGE:
 * [my_elel args="posts_per_page=10&post_type=page&post_parent=1" template="card" css_class=""]
 */
function my_elel_shortcode($atts) {
	...
	if ($the_query->have_posts()) {
		...
		while ( $the_query->have_posts() ) {
			...
			get_template_part( 'template-parts/content-property', $template );
 ...
 add_shortcode("my_elel", "my_elel_shortcode");